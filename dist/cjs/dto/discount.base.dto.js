...
var discount_bulk_item_dto_1 = require("./discount.bulk.item.dto");
var discount_bxgy_item_dto_1 = require("./discount.bxgy.item.dto");
var discount_bxgx_item_dto_1 = require("./discount.bxgx.item.dto");
var discount_filter_item_dto_1 = require("./discount.filter.item.dto");
var discount_condition_item_dto_1 = require("./discount.condition.item.dto");
...
var DiscountBaseDto = /** @class */ (function () {
    ...
    __decorate([
        (0, ts_mixer_1.decorate)((0, class_transformer_1.Expose)()),
        (0, ts_mixer_1.decorate)((0, class_validator_1.IsNotEmpty)()),
        (0, ts_mixer_1.decorate)((0, class_validator_1.IsEnum)(discountType_1.DiscountType)),
        __metadata("design:type", String)
    ...
    __decorate([
        ...
        (0, ts_mixer_1.decorate)((0, class_validator_1.IsEnum)(productAdjustmentDiscountType_1.ProductAdjustmentDiscountType)),
        __metadata("design:type", String)
    ...
    __decorate([
        ...
        (0, ts_mixer_1.decorate)((0, class_validator_1.IsEnum)(cartAdjustmentDiscountType_1.CartAdjustmentDiscountType)),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, ts_mixer_1.decorate)((0, class_transformer_1.Expose)()),
        (0, ts_mixer_1.decorate)((0, class_validator_1.ValidateIf)(function (o) { return o.discountType === discountType_1.DiscountType.BULK_ADJUSTMENT; })),
        (0, ts_mixer_1.decorate)((0, class_validator_1.IsEnum)(bulkAdjustmentCountType_1.BulkAdjustmentCountType)),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, ts_mixer_1.decorate)((0, class_transformer_1.Expose)()),
        (0, ts_mixer_1.decorate)((0, class_validator_1.ValidateIf)(function (o) { return o.discountType === discountType_1.DiscountType.BXGY; })),
        (0, ts_mixer_1.decorate)((0, class_validator_1.IsEnum)(BXGYCountType_1.BXGYCountType)),
        __metadata("design:type", String)
    ], DiscountBaseDto.prototype, "BXGYCountType", void 0);
    __decorate([
        (0, ts_mixer_1.decorate)((0, class_transformer_1.Expose)()),
        (0, ts_mixer_1.decorate)((0, class_validator_1.ValidateIf)(function (o) { return o.discountType === discountType_1.DiscountType.BXGY; })),
        (0, ts_mixer_1.decorate)((0, class_validator_1.IsEnum)(BXGYGetType_1.BXGYGetType)),
        __metadata("design:type", String)
