...
__decorate([
    ...
    Transform(({ value, obj }) => {
        var _a;
        return (_a = value === null || value === void 0 ? void 0 : value.filter((_valueObj, index) => !(obj === null || obj === void 0 ? void 0 : obj.isBXGXRecursive) || index < 1)) === null || _a === void 0 ? void 0 : _a.map((valueObj) => {
...
__decorate([
    ...
    Transform(({ value, obj }) => {
        var _a;
        return (_a = value === null || value === void 0 ? void 0 : value.filter((_valueObj, index) => !(obj === null || obj === void 0 ? void 0 : obj.isBXGYRecursive) || index < 1)) === null || _a === void 0 ? void 0 : _a.map((valueObj) => {
