...
var BulkAdjustmentCountType = require('enum/BulkAdjustmentCountType');
var CartAdjustmentDiscountType = require('enum/CartAdjustmentDiscountType');
var DiscountType = require('enum/DiscountType');
var ProductAdjustmentDiscountType = require('enum/ProductAdjustmentDiscountType');
var BXGYType = require('enum/BXGYType');
var BXGYCountType = require('enum/BXGYCountType');
var BXGYGetType = require('enum/BXGYGetType');
...
var bulkDiscountType = require('enum/bulkDiscountType');
var BXGXDiscountType = require('enum/BXGXDiscountType');
var BXGYDiscountType = require('enum/BXGYDiscountType');
var discount_list_item_dto = require('dto/discount.list.item.dto');
var conditionCountType = require('enum/conditionCountType');
var conditionOperator = require('enum/conditionOperator');
var discountConditionType = require('enum/discountConditionType');
var discount_base_dto = require('dto/discount.base.dto');
var DiscountFilterType = require('enum/DiscountFilterType');
...
tslib.__decorate([classValidator.IsNotEmpty(), classValidator.IsEnum(DiscountType.DiscountType)], DiscountBaseDto.prototype, "discountType", void 0);
...
tslib.__decorate([classValidator.ValidateIf(function (o) {
  return o.discountType === DiscountType.DiscountType.PRODUCT_ADJUSTMENT;
}), classValidator.IsEnum(ProductAdjustmentDiscountType.ProductAdjustmentDiscountType)], DiscountBaseDto.prototype, "productAdjustmentDiscountType", void 0);
tslib.__decorate([classValidator.ValidateIf(function (o) {
  return o.discountType === DiscountType.DiscountType.PRODUCT_ADJUSTMENT;
}), classValidator.IsDecimal()], DiscountBaseDto.prototype, "productAdjustmentDiscountAmount", void 0);
tslib.__decorate([classValidator.ValidateIf(function (o) {
  return o.discountType === DiscountType.DiscountType.CART_ADJUSTMENT;
}), classValidator.IsEnum(CartAdjustmentDiscountType.CartAdjustmentDiscountType)], DiscountBaseDto.prototype, "cartAdjustmentDiscountType", void 0);
tslib.__decorate([classValidator.ValidateIf(function (o) {
  return o.discountType === DiscountType.DiscountType.CART_ADJUSTMENT;
...
tslib.__decorate([classValidator.ValidateIf(function (o) {
  return o.discountType === DiscountType.DiscountType.BULK_ADJUSTMENT;
}), classValidator.IsEnum(BulkAdjustmentCountType.BulkAdjustmentCountType)], DiscountBaseDto.prototype, "bulkAdjustmentCountType", void 0);
tslib.__decorate([classValidator.ValidateIf(function (o) {
  return o.discountType === DiscountType.DiscountType.BULK_ADJUSTMENT;
...
tslib.__decorate([classValidator.ValidateIf(function (o) {
  return o.discountType === DiscountType.DiscountType.BXGX;
...
tslib.__decorate([classValidator.ValidateIf(function (o) {
  return o.discountType === DiscountType.DiscountType.BXGY;
}), classValidator.IsEnum(BXGYType.BXGYType)], DiscountBaseDto.prototype, "BXGYType", void 0);
tslib.__decorate([classValidator.ValidateIf(function (o) {
  return o.discountType === DiscountType.DiscountType.BXGY;
}), classValidator.IsEnum(BXGYCountType.BXGYCountType)], DiscountBaseDto.prototype, "BXGYCountType", void 0);
tslib.__decorate([classValidator.ValidateIf(function (o) {
  return o.discountType === DiscountType.DiscountType.BXGY;
}), classValidator.IsEnum(BXGYGetType.BXGYGetType)], DiscountBaseDto.prototype, "BXGYGetType", void 0);
tslib.__decorate([classValidator.ValidateIf(function (o) {
  return o.discountType === DiscountType.DiscountType.BXGY;
...
tslib.__decorate([classValidator.IsNotEmpty(), classValidator.IsEnum(bulkDiscountType.BulkDiscountType)], DiscountBulkItemDto.prototype, "discountType", void 0);
...
tslib.__decorate([classValidator.IsNotEmpty(), classValidator.IsEnum(BXGXDiscountType.BXGXDiscountType)], DiscountBxgxItemDto.prototype, "discountType", void 0);
tslib.__decorate([classValidator.ValidateIf(function (o) {
  return o.discountType !== BXGXDiscountType.BXGXDiscountType.FREE;
...
tslib.__decorate([classValidator.IsNotEmpty(), classValidator.IsEnum(BXGYDiscountType.BXGYDiscountType)], DiscountBxgyItemDto.prototype, "discountType", void 0);
tslib.__decorate([classValidator.ValidateIf(function (o) {
  return o.discountType !== BXGYDiscountType.BXGYDiscountType.FREE;
...
tslib.__decorate([classValidator.IsNotEmpty(), classValidator.IsEnum(BXGYType.BXGYType)], DiscountBxgyItemDto.prototype, "BXGYType", void 0);
tslib.__decorate([classValidator.ValidateIf(function (o) {
...
tslib.__decorate([classValidator.ValidateIf(function (o) {
  return o.BXGYType === BXGYType.BXGYType.PRODUCTS;
}), classValidator.IsArray(), classValidator.ValidateNested({
  each: true
}), classValidator.ArrayMinSize(1), classTransformer.Type(function () {
...
tslib.__decorate([classValidator.ValidateIf(function (o) {
  return o.BXGYType === BXGYType.BXGYType.COMPANIES;
}), classValidator.IsArray(), classValidator.ValidateNested({
  each: true
}), classValidator.ArrayMinSize(1), classTransformer.Type(function () {
  return discount_list_item_dto.DiscountListItemDto;
...
tslib.__decorate([classValidator.ValidateIf(function (o) {
  return o.BXGYType === BXGYType.BXGYType.CATEGORIES;
}), classValidator.IsArray(), classValidator.ValidateNested({
  each: true
}), classValidator.ArrayMinSize(1), classTransformer.Type(function () {
  return discount_list_item_dto.DiscountListItemDto;
...
tslib.__decorate([classValidator.IsNotEmpty(), classValidator.IsEnum(conditionOperator.ConditionOperator)], DiscountConditionItemDto.prototype, "conditionOperator", void 0);
tslib.__decorate([classValidator.IsNotEmpty(), classValidator.IsEnum(discountConditionType.DiscountConditionType)], DiscountConditionItemDto.prototype, "conditionType", void 0);
tslib.__decorate([classValidator.IsNotEmpty(), classValidator.IsEnum(conditionCountType.ConditionCountType)], DiscountConditionItemDto.prototype, "conditionCountType", void 0);
...
}(discount_base_dto.DiscountBaseDto);
...
tslib.__decorate([classValidator.IsNotEmpty(), classValidator.IsEnum(DiscountFilterType.DiscountFilterType)], DiscountFilterItemDto.prototype, "discountFilterType", void 0);
tslib.__decorate([classValidator.ValidateIf(function (o) {
  return o.discountFilterType !== DiscountFilterType.DiscountFilterType.ALL;
}), classTransformer.Transform(function (_ref) {
  var value = _ref.value;
  return [true, 'enabled', 'true', 1, '1'].indexOf(value) > -1;
})], DiscountFilterItemDto.prototype, "isInList", void 0);
tslib.__decorate([classValidator.ValidateIf(function (o) {
  return o.discountFilterType === DiscountFilterType.DiscountFilterType.PRODUCTS;
}), classValidator.IsArray(), classValidator.ValidateNested({
  each: true
}), classValidator.ArrayMinSize(1), classTransformer.Type(function () {
  return discount_list_item_dto.DiscountListItemDto;
...
tslib.__decorate([classValidator.ValidateIf(function (o) {
  return o.discountFilterType === DiscountFilterType.DiscountFilterType.COMPANIES;
}), classValidator.IsArray(), classValidator.ValidateNested({
  each: true
}), classValidator.ArrayMinSize(1), classTransformer.Type(function () {
  return discount_list_item_dto.DiscountListItemDto;
...
tslib.__decorate([classValidator.ValidateIf(function (o) {
  return o.discountFilterType === DiscountFilterType.DiscountFilterType.CATEGORIES;
}), classValidator.IsArray(), classValidator.ValidateNested({
  each: true
}), classValidator.ArrayMinSize(1), classTransformer.Type(function () {
  return discount_list_item_dto.DiscountListItemDto;
...
tslib.__decorate([classValidator.IsNotEmpty(), classValidator.IsNumber()], DiscountListItemDto.prototype, "id", void 0);
...
exports.DiscountListItemDto = DiscountListItemDto;
