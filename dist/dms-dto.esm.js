...
import { IsOptional, ValidateIf, IsNumber, IsNotEmpty, IsInt, IsEnum, IsDecimal, IsString, Allow, IsBoolean, IsArray, ValidateNested, ArrayMinSize, IsDateString, Length, validate } from 'class-validator';
...
__decorate([IsNotEmpty(), IsNumber()], AutoCompleteOptionItemDto.prototype, "id", void 0);
__decorate([Allow()], AutoCompleteOptionItemDto.prototype, "label", void 0);
